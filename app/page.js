    ...
    from-primary to-neutral-600 font-sans font-bold mb-5">
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h1
            ...
            mb-5">
            Your Personal AI PDF Editor
          </h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            Unlock the potential of your documents with our AI-powered
            assistant—upload your PDF and get answers to anything related
            instantly.
          </p>
      ...
      <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h2 className="text-md text-gray-500">
          Make your own desire PDF in just 3 simplar easy step
        </h2>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
         ...
         hover:border-pink-500/10 hover:shadow-blue-500/40 cursor-pointer">
            ...
            <h2 className="mt-4 text-xl font-bold text-black">
              Upload Your PDF & Generate Prompts
            </h2>

            <p className="mt-1 text-sm text-gray-600">
              In this section, you can upload your PDF or document, and our AI
              will analyze its content to create specific questions or scenarios
              tailored to the context of your file. Whether it’s a resume,
              report, or academic paper, our tool ensures the generated prompts
          ...
          <a className="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-blue-500/40 cursor-pointer">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Fine-tuning your prompts is crucial to ensure they align with your
              learning or analysis goals. This section lets you edit, delete, or
              rearrange the generated questions effortlessly. You can preview
              how these questions will guide interactions, ensuring they deliver
              meaningful insights before proceeding further.
            </p>
          </a>
          ...
          <a className="block rounded-xl border bg-white border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-blue-500/40 cursor-pointer">
            ...
            <h2 className="mt-4 text-xl font-bold text-black">
              Share & Gather Insights
            </h2>

            <p className="mt-1 text-sm text-gray-600">
              Easily distribute your uploaded content and prompts by generating
              a shareable link, sending direct email invitations, or embedding
              it into your website. Track responses in real-time through our
              interactive dashboard, where you can monitor engagement, manage
              incoming queries, and review detailed insights efficiently.
            </p>
          </a>
        </div>
      </section>
